      ...
      <div className="text-center">
        <div
          ...
          className={`relative border-2 border-dashed rounded-xl p-10 transition-all duration-500 ease-out cursor-pointer group overflow-hidden ${
            isDragActive 
              ...
              : 'border-indigo-200 hover:border-indigo-400 hover:bg-blue-50 hover:shadow-md'
          }`}
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10"></div>
          ...
          {isUploading ? (
            ...
            <div className="py-10">
              <div className="w-24 h-24 bg-gradient-to-br from-indigo-50 to-purple-50 rounded-full flex items-center justify-center mx-auto mb-6 shadow group-hover:shadow-lg transition-all group-hover:scale-110 duration-300">
              ...
              <p className="text-gray-800 text-xl font-semibold mb-2 group-hover:text-indigo-700 transition-colors">Drag & drop your room images here</p>
        ...
        {uploadStatus && (
          <div className={`mt-6 p-4 rounded-lg transform transition-all duration-500 ${
            uploadStatus.includes('failed') 
              ? 'bg-red-50 text-red-700 border border-red-200 shadow-md' 
        ...
        {previewUrls.length > 0 && (
          <div className="mt-16 transition-all duration-500 ease-out transform">
            <h3 className="text-xl font-semibold text-gray-800 mb-6 inline-block relative">
              Preview
        ...
        {uploadedFiles.length > 0 && (
          <div className="mt-16 bg-gradient-to-br from-indigo-50 to-purple-50 p-8 rounded-2xl border border-indigo-100 shadow-lg transition-all duration-300 hover:shadow-xl">
            <h3 className="text-xl font-semibold text-indigo-800 mb-6 inline-block relative">
              Uploaded Files
              <span className="absolute -bottom-1 left-0 w-full h-1 bg-gradient-to-r from-indigo-400 to-purple-400 rounded-full"></span>
            </h3>
            <ul className="space-y-3 mb-8">
              {uploadedFiles.map((url, index) => (
                <li key={index} className="flex items-center justify-center space-x-3 p-3 bg-white bg-opacity-80 rounded-lg hover:bg-opacity-100 transition-all duration-300 shadow-sm hover:shadow">
        ...
        {suggestions.length > 0 && (
          <div className="mt-16 bg-gradient-to-br from-purple-50 to-indigo-50 p-8 rounded-2xl border border-purple-100 shadow-lg transition-all duration-300 hover:shadow-xl">
            <h3 className="text-xl font-semibold text-purple-800 mb-6 inline-block relative">
              Design Suggestions
            ...
            {suggestions.map((suggestion, index) => (
              <div key={index} className="bg-white p-6 rounded-xl shadow-md mb-6 transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1">
                ...
                {suggestion.error ? (
                  ...
                  <div className="space-y-4">
                    <div className="bg-indigo-50 p-4 rounded-lg border border-indigo-100">
                      <h5 className="text-sm font-semibold text-indigo-700 mb-3 flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {suggestion.detectedObjects && suggestion.detectedObjects.length > 0 ? 
                          suggestion.detectedObjects.map((obj, idx) => (
                            <span key={idx} className="px-3 py-1 bg-white rounded-full text-xs font-medium text-indigo-600 border border-indigo-100 shadow-sm">
